...
RUN sed -i \
    ...
    -e 's|<IncomingMailServer.*>|<IncomingMailServer>info.baiwangjinfu.com</IncomingMailServer>|' \
    ...
    -e 's|<OutgoingMailServer.*>|<OutgoingMailServer>info.baiwangjinfu.com</OutgoingMailServer>|' \
